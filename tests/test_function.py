...
def fake_automation_run_data(request, test_client: SpeckleClient) -> AutomationRunData:
    ...
    function_name = request.config.FUNCTION_NAME

    automation_id = crypto_random_string(10)
    automation_name = request.config.AUTOMATION_NAME
    ...
    fake_run_data = AutomationRunData(
        ...
        model_id=model_id,
        branch_name=request.config.BRANCH_NAME,
        version_id=request.config.VERSION_ID,
        ...
        function_id=request.config.FUNCTION_ID,
